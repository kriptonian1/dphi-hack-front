...
/**
 * @name NewHack
 * @description renders the NewHack page
 * @returns {JSX.Element} NewHack page
 */
const NewHack = (props) => {
    ...
    const data = hackData.find((hack) => hack.id == params.id) // this is the hackathon data that we want to edit
    ...
    const [nameVal, setNameVal] = useState(data.title)
    ...
    return (
        <div>
            ...
            <Helmet>
                <title>{`Edit ${data.status} Hackathon | DPhi`}</title>
            </Helmet>
            ...
            <form className='flex flex-col px-[6vw] py-10'>
                ...
                <div className='flex flex-col pb-8'>
                    ...
                    <input className='border-2 border-[#B7B7B7] px-5 py-2 w-[350px] rounded ' onChange={(e) => onChangeName(e)} value={nameVal} required type="text" placeholder="Enter challenge name" />
                </div>
                ...
                <div className='flex flex-col pb-8'>
                    ...
                    <textarea value={descVal} onChange={(e) => onChangeDesc(e)} required className='border-2  border-[#B7B7B7] px-5 py-2 w-[60vw] md:w-[50vw] rounded ' id="story" name="story"
